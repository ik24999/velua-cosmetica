# Workflow — Website Design Recreation
...
2. Make sure the rendered page using Puppeteer (`npx puppeteer screenshot index.html --fullPage`) matches the reference image. If the page has distinct sections, capture those individually too.
...
4. Fix everything found. Edit the HTML/Tailwind code.
